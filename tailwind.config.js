  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        darkModeTextColor: { DEFAULT: 'rgba(255, 255, 255, 0.9)', 100: 'rgba(255, 255, 255, 0.6)' },
      },
      boxShadow: {
        mainColorShadow: '0 10px 60px 0 #4520ab',
        thirdColorShadow: '0 0 20px 0 #66eefb',
        secondColorShadow: '0 0 20px 0 #FFBC5B',
        red: '0 0 10px 0 #FDA5A5',
        green: '0 0 10px 0 #6EE7B7',
      },
    },
  },
  variants: {
